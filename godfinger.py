    ...
    def __init__(self):
        ...
        if cfgIface == "pty":
            ...
            for idx, remote_cfg in enumerate(rcon_cfg["Remotes"]):
                ...
                # Supremacy writes server.log to SupremacyPath (fs_supremacy dir), not MBIIPath.
        ...
        # Archives — load pk3s from both the MBII and MBII and Supremacy game directories
