...
> 
> Execute `"prepare.bat"` to install dependancy modules, sufficiently fill out `config jsons`, then just start the `"start"` or `"startDebug"` based on platform in `./start/os`.
